"""Financial Analysis Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Financial analysis agent that performs variance analysis, builds financial models, generates P&L breakdowns, calculates unit economics, and provides scenario planning for budget and forecast cycles.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
