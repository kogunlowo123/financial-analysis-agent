"""Financial Analysis Agent - Main Agent Implementation."""
...
class FinancialAnalysisAgentAgent:
    """
    ...
    def __init__(self):
        ...
        self.variance_analysis_enabled = True
        self.financial_modeling_enabled = True
        self.pl_breakdown_enabled = True
        self.unit_economics_enabled = True
        self.scenario_planning_enabled = True
        self._tool_dispatch = {
            "analyze_variance": self.tools.analyze_variance,
            "build_financial_model": self.tools.build_financial_model,
            "break_down_pl": self.tools.break_down_pl,
            "calculate_unit_economics": self.tools.calculate_unit_economics,
        ...
        logger.info(
            ...
            features=['variance_analysis', 'financial_modeling', 'pl_breakdown', 'unit_economics', 'scenario_planning'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            "analyze_variance": ['analyze', 'variance'],
            "build_financial_model": ['build', 'financial', 'model'],
            "break_down_pl": ['break', 'down', 'pl'],
