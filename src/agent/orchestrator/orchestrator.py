"""Financial Analysis Agent — Agent Orchestrator (Plan → Research → Execute → Validate → Respond)."""
...
class AgentOrchestrator:
    """Orchestrates the Financial Analysis Agent through a multi-step pipeline.
